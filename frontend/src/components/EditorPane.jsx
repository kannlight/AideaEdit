...
export default function EditorPane() {
    ...
    return (
        <div className="pane bg-white shadow-[-4px_0_24px_rgba(0,0,0,0.02)]">
            <div className="p-4 border-b border-border flex justify-between items-center bg-white sticky top-0 z-10">
                <div className="flex items-center gap-3">
                    <h2 className="font-semibold text-gray-700">Final Prose</h2>
                    <select
                        value={format}
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-1.5 bg-accent text-white text-sm font-medium rounded-md hover:bg-accent/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                    >
                        <Sparkles size={16} />
            ...
            <div className="flex-1 flex flex-col overflow-hidden p-8 max-w-3xl mx-auto w-full">
                {prose ? (
                    <textarea
                        ...
                        className="flex-1 w-full p-4 border-none focus:ring-0 whitespace-pre-wrap font-serif text-lg leading-relaxed text-gray-800 outline-none resize-none bg-transparent"
                        spellCheck="false"
                    />
                ) : (
                    <div className="flex-1 flex flex-col items-center justify-center p-20 text-gray-300 border-2 border-dashed border-gray-100 rounded-xl">
            ...
            <div className="p-4 border-t border-border bg-gray-50/50">
                <div className="max-w-3xl mx-auto flex gap-2">
                    <input
                        ...
                        className="flex-1 p-2.5 text-sm border border-border rounded-md focus:ring-2 focus:ring-accent/20 outline-none shadow-inner"
                    />
                    <button
